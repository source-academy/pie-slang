...
function varType(ctx: Context, where: Location, x: string): Perhaps<Value> {
...
function bindFree(ctx: Context, varName: string, tv: Value): Context {
...
function bindVal(ctx: Context, varName: string, type: Value, value: Value): Context {
