...
describe("alpha equivalence", () => {
    describe("Variable tests", () => {
        it("should check alpha equivalence of bound variables with different names", () => {
            ...
            expect((0, alphaeqv_1.alphaEquiv)(expr1, expr2)).toBe(true);
        });
        ...
        it("should distinguish bound from free variables", () => {
            ...
            expect((0, alphaeqv_1.alphaEquiv)(expr1, expr2)).toBe(false);
        });
    ...
    describe("Application tests", () => {
        ...
        it("should handle nested applications", () => {
            const expr1 = new C.Application(new C.Lambda('x', new C.Application(new C.VarName('x'), new C.Zero())), new C.Lambda('y', new C.Application(new C.VarName('y'), new C.Add1(new C.Zero()))));
            const expr2 = new C.Application(new C.Lambda('a', new C.Application(new C.VarName('a'), new C.Zero())), new C.Lambda('b', new C.Application(new C.VarName('b'), new C.Add1(new C.Zero()))));
            expect((0, alphaeqv_1.alphaEquiv)(expr1, expr2)).toBe(true);
        });
    });
    describe("Natural number tests", () => {
        it("should handle zero", () => {
            expect((0, alphaeqv_1.alphaEquiv)(new C.Zero(), new C.Zero())).toBe(true);
        });
    ...
    describe("List tests", () => {
        ...
        it("should handle nil", () => {
            expect((0, alphaeqv_1.alphaEquiv)(new C.Nil(), new C.Nil())).toBe(true);
        });
    ...
    describe("Vector tests", () => {
        ...
        it("should handle vecnil", () => {
            expect((0, alphaeqv_1.alphaEquiv)(new C.VecNil(), new C.VecNil())).toBe(true);
        });
    ...
    describe("Either tests", () => {
        ...
        it("should handle left and right", () => {
            ...
            expect((0, alphaeqv_1.alphaEquiv)(expr3, expr4)).toBe(true);
        });
    ...
    describe("Complex expression tests", () => {
        it("should handle complex nested expressions", () => {
            ...
            const expr1 = new C.Lambda('f', new C.Lambda('x', new C.Application(new C.VarName('f'), new C.VarName('x'))));
            const expr2 = new C.Lambda('g', new C.Lambda('y', new C.Application(new C.VarName('g'), new C.VarName('y'))));
            expect((0, alphaeqv_1.alphaEquiv)(expr1, expr2)).toBe(true);
        });
        it("should handle dependent types with applications", () => {
            ...
            const expr1 = new C.Pi('A', new C.Universe(), new C.Pi('f', innerPi, new C.Application(new C.VarName('f'), new C.Zero())));
            const innerPi2 = new C.Pi('y', new C.VarName('B'), new C.VarName('B'));
            const expr2 = new C.Pi('B', new C.Universe(), new C.Pi('g', innerPi2, new C.Application(new C.VarName('g'), new C.Zero())));
            expect((0, alphaeqv_1.alphaEquiv)(expr1, expr2)).toBe(true);
        });
    ...
    describe("Edge cases", () => {
        it("should handle empty expressions correctly", () => {
            expect((0, alphaeqv_1.alphaEquiv)(new C.Sole(), new C.Sole())).toBe(true);
        });
        it("should handle completely different expression types", () => {
            expect((0, alphaeqv_1.alphaEquiv)(new C.Nat(), new C.Lambda('x', new C.VarName('x')))).toBe(false);
        });
...
//# sourceMappingURL=test_alpha.js.map