...
export declare function makeDefineDatatype(stx: Syntax, name: string, parameters: TypedBinder[], indices: TypedBinder[], constructors: GeneralConstructor[], eliminatorName?: string): DefineDatatypeSource;
