...
var _1 = require(".");
var parser_error_1 = require("../../parser/parser-error");
var Group = /** @class */ (function () {
    ...
    Group.build = function (elements) {
        ...
        if (elements.length === 2) {
            var firstElement_1 = elements[0];
            // Ensure the first element is an affector type and
            if ((0, _1.isToken)(firstElement_1) && isShortAffector(firstElement_1)) {
                return new Group(elements);
            }
        ...
        // This should never happen.
        var wrongGroup = new Group(elements);
    ...
    Group.prototype.firstToken = function () {
    ...
    Group.prototype.firstPos = function () {
    ...
    Group.prototype.lastToken = function () {
    ...
    Group.prototype.lastPos = function () {
        return this.lastToken().pos;
    };
    /**
     * Check if the current group is parenthesized.
     */
    Group.prototype.isParenthesized = function () {
        var firstElement = this.first();
     ...
     */
    Group.prototype.isSingleIdentifier = function () {
     ...
     */
    Group.prototype.unwrap = function () {
