...
export declare function makeElimNat(stx: Syntax, target: string): Tactic;
...
export declare function makeThenTactic(stx: Syntax, tactics: Tactic[]): Tactic;
export declare function makeApplyTactic(stx: Syntax, funcExpr: S.Source): Tactic;
export declare function makeDefineDatatype(stx: Syntax, name: string, parameters: TypedBinder[], indices: TypedBinder[], constructors: GeneralConstructor[], eliminatorName?: string): TypeDefinition;
export declare function makeGeneralConstructor(stx: Syntax, name: string, args: TypedBinder[], returnType: S.GeneralTypeConstructor): GeneralConstructor;
export declare function makeConstructorApplication(stx: Syntax, constructorName: string, args: S.Source[]): S.ConstructorApplication;
export declare function makeEliminatorApplication(stx: Syntax, typeName: string, target: S.Source, motive: S.Source, methods: S.Source[]): S.EliminatorApplication;
export declare function makeGeneralTypeConstructor(stx: Syntax, name: string, params: S.Source[], indices: S.Source[]): S.GeneralTypeConstructor;
