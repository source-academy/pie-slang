...
export declare class Universe extends Source {
    ...
    protected synthHelper(ctx: Context, renames: Renaming): Perhaps<C.The>;
    findNames(): string[];
    getType(_ctx: Context, _renames: Renaming): Perhaps<C.Core>;
    prettyPrint(): string;
    toString(): string;
}
...
export declare class GeneralType extends Source {
    location: Location;
    name: string;
    paramType: TypedBinder[];
    indicesType: TypedBinder[];
...
export declare class EliminatorApplication extends Source {
    ...
    motive: Source;
    methods: Source[];
    constructor(location: Location, typeName: string, // e.g., "MyList", "Bool"
    target: Source, // The value to eliminate
    motive: Source, // The motive function
    methods: Source[]);
    findNames(): string[];
    prettyPrint(): string;
    protected synthHelper(ctx: Context, renames: Renaming): Perhaps<C.The>;
}
export declare class ConstructorApplication extends Source {
    location: Location;
