...
export declare class InductiveTypeConstructor extends Core {
    typeName: string;
    parameters: Core[];
    indices: Core[];
    valOf(env: Environment): V.Value;
...
export declare class InductiveType extends Core {
    ...
    indexTypes: Core[];
    valOf(env: Environment): V.Value;
    constructor(typeName: string, parameterTypes: Core[], indexTypes: Core[]);
    prettyPrint(): string;
}
export declare class Constructor extends Core {
    ...
    args: Core[];
    recursive_args: Core[];
    constructor(name: string, index: number, type: string, args: Core[], recursive_args: Core[]);
    valOf(env: Environment): V.Constructor;
    prettyPrint(): string;
}
export declare class ConstructorType extends Core {
    name: string;
    index: number;
    type: string;
    argTypes: Core[];
...
export declare class Eliminator extends Core {
    ...
    motive: Core;
    methods: Core[];
    methodTypes?: Core[] | undefined;
    motiveType?: Core | undefined;
    constructor(typeName: string, target: Core, motive: Core, methods: Core[], methodTypes?: Core[] | undefined, // Optional: method types for proper Neutral handling
    motiveType?: Core | undefined);
    valOf(env: Environment): V.Value;
    prettyPrint(): string;
}
export declare class EliminatorType extends Core {
    typeName: string;
    targetType: Core;
    motiveType: Core;
    methodTypes: Core[];
    constructor(typeName: string, targetType: Core, motiveType: Core, methodTypes: Core[]);
    valOf(env: Environment): V.Value;
    prettyPrint(): string;
}
