...
export declare class InductiveTypeConstructor extends Value {
    name: string;
    parameters: Value[];
    indices: Value[];
...
export declare class InductiveType extends Value {
    ...
    indexTypes: Value[];
    constructor(name: string, parameterTypes: Value[], indexTypes: Value[]);
    readBackType(context: Context): C.Core;
    prettyPrint(): string;
    toString(): string;
}
export declare class Constructor extends Value {
    ...
    readBackType(_context: Context): C.Core;
    prettyPrint(): string;
    toString(): string;
}
export declare class ConstructorType extends Value {
    name: string;
    index: number;
    type: string;
    argTypes: Value[];
...
export declare class EliminatorType extends Value {
    ...
    motiveType: Value;
    methodTypes: Value[];
    constructor(typeName: string, targetType: Value, motiveType: Value, methodTypes: Value[]);
    readBackType(context: Context): C.Core;
    prettyPrint(): string;
    toString(): string;
}
